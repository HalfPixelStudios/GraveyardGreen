...
public class CameraController : MonoBehaviour {
    ...
    void Update()
    {
        ...
        transform.position = new Vector3(offset.x+Mathf.Lerp(transform.position.x-offset.x, target.transform.position.x,t),transform.position.y,offset.z+Mathf.Lerp(transform.position.z-offset.z, target.transform.position.z,t));
